...
window.addEventListener('gamepaddisconnected', (event) => {
    ...
    window.addEventListener('gamepadconnected', event => {
        ...
        if ((
            ...
            event.gamepad === upPressed ||
            event.gamepad === downPressed ||
            event.gamepad === leftPressed ||
            event.gamepad === rightPressed ||
            event.gamepad === gPressed ||
            event.gamepad === bPressed ||
            event.gamepad === pPressed ||
            event.gamepad === rPressed
                )&& this.gamepads.indexOf(event.gamepad) === -1){
                   
                    this.gamepads.push(event.gamepad);
                } else if (event.gamepad === 'd') this.game.debug = !this.game.debug;
    ...
    controllerInput(){
        if (controllerIndex !== null) {
            ...
            leftPressed = buttons[14].pressed;
             ...
             rPressed = buttons[1].pressed
             bPressed = buttons[0].pressed
             pPressed = buttons[2].pressed
             gPressed = buttons[3].pressed
        }
    }
