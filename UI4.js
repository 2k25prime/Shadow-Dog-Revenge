export class UI {
    ...
    draw(context){
        ...
        //score
        context.fillText('Score, 130 to win:      ' + this.game.score, 20, 50);
        // timer
        context.font = this.fontSize * 0.8 + 'px ' + this.fontFamily;
        context.fillText('Time, 100 secs:   ' + (this.game.time * 0.001).toFixed(1), 20, 80);
        // energy
        context.font = this.fontSize * 0.8 + 'px ' + this.fontFamily;
        context.fillText('Energy, max is 50:    ' + (this.game.energy * 0.001).toFixed(1), 20, 150);
        //stamina
        context.font = this.fontSize * 0.8 +'px ' + this.fontFamily;
        context.fillText('Stamina, max is 25:    ' + (this.game.stamina *0.001).toFixed(1), 30, 220);
        // lives
